...
sys.stdout.write('\x1b]2;  MOHAMMAD ALAMIN\x07')
...
def logo():
    print(" ");print(Panel("[bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]● [bold green]●[bold red]● [bold yellow]●\n    [green1] ╺┳╸┏━╸┏━┓┏┳┓╻ ╻╻ ╻   ┏━┓┏━╸╺┳╸╻ ╻┏━┓\n    [spring_green2]  ┃ ┣╸ ┣┳┛┃┃┃┃ ┃┏╋┛   ┗━┓┣╸  ┃ ┃ ┃┣━┛\n    [spring_green11]  ╹ ┗━╸╹┗╸╹ ╹┗━┛╹ ╹   ┗━┛┗━╸ ╹ ┗━┛╹", style="bold bright_black",title="<[bold white reverse] CODING BY - MOHAMMAD ALAMIN [/bold white reverse]>"))
    print(Panel("[bold black]【[white]•[bold black]】[bold yellow] DEVELOPER   [white]➤ [dark_olive_green2]MOHAMMAD ALAMIN \n[bold black]【[white]•[bold black]】[bold yellow] GITHUB      [white]➤ [dark_olive_green2]ALAMIN2K7 \n[bold black]【[white]•[bold black]】[bold yellow] VERSION     [white]➤ [dark_olive_green2]2K7\n[bold black]【[white]•[bold black]】[bold yellow] TELEGRAM    [white]➤ [dark_olive_green2]t.me/ALAMIN2K7\n[bold black]【[white]•[bold black]】[bold yellow] TOOL'S NAME [white]➤ [bold purple reverse] TERMUX BESIC SETUP ", style="bold bright_black"))
...
def menu():
    ...
    elif option in ['2','02','B','b']:clear();os.system('rm -rf T-BANNER && cd && git clone https://github.com/ALAMIN2K7/T-BANNER.git && cd T-BANNER && python2 banner.py')
...
def admin():
    clear()
    print(Panel("[bold black]【[white]01[bold yellow]/[white]A[bold black]】[cyan3]Facebook\n[bold black]【[white]02[bold yellow]/[white]B[bold black]】[cyan3]Whatsapp\n[bold black]【[white]03[bold yellow]/[white]C[bold black]】[cyan3]Telegram\n[bold black]【[white]04[bold yellow]/[white]D[bold black]】[cyan3]Github\n[bold black]【[white]00[bold yellow]/[white]X[bold black]】[red1]BACK TO MAIN MENU", style="bold bright_black",title="<[bold white reverse] CONTACT ADMIN [/bold white reverse]>"))
    option = Console().input("[bold bright_black]   ╰─>[white] ")
    if option in ['1','01','A','a']:os.system('xdg-open https://www.facebook.com/MOHAMMADALAMIN2K7');menu()
    elif option in ['2','02','B','b']:os.system('xdg-open https://wa.me/+8801300504976');menu()
    elif option in ['3','03','C','c']:os.system('xdg-open https://t.me/ALAMIN2K7');menu()
    elif option in ['4','04','D','d']:os.system('xdg-open https://github.com/ALAMIN2K7');menu()
