...
def logo():
    ...
    print(Panel(
        "[bold black]【[white]•[bold black]】[bold yellow] TOOL'S NAME [white]➤ [dark_olive_green2]TERMUX SETUP TOOL\n"
        "[bold black]【[white]•[bold black]】[bold yellow] VERSION     [white]➤ [dark_olive_green2]1.0\n"
        "[bold black]【[white]•[bold black]】[bold yellow] AUTHOR      [white]➤ [dark_olive_green2]MOHAMMAD ALAMIN\n"
        "[bold black]【[white]•[bold black]】[bold yellow] GITHUB      [white]➤ [dark_olive_green2]ALAMIN2K7\n"
        "[bold black]【[white]•[bold black]】[bold yellow] TELEGRAM    [white]➤ [dark_olive_green2]ALAMIN2K7",
        style="bold bright_black"
    ))
